...
def show_application():
    ...
    def display_tables(canvas_frame):
        ...
        title_company_label = Label(canvas_frame, font="Georgia 13", text="Company name: ", bg="white")
        title_company_label.grid(row=0, column=0)
        title_contact_date_label = Label(canvas_frame, font="Georgia 13", text="Contact date: ", bg="white")  
        title_contact_date_label.grid(row=0, column=1)
        title_action_label = Label(canvas_frame, font="Georgia 13", text="Action: ", bg="white") 
        title_action_label.grid(row=0, column=2)
        title_job_title_label = Label(canvas_frame, font="Georgia 13", text="Job title: ", bg="white")
        title_job_title_label.grid(row=0, column=3)
        title_job_link_label = Label(canvas_frame, font="Georgia 13", text="Job link: ", bg="white")
        title_job_link_label.grid(row=0, column=4)
        title_contact_name_label = Label(canvas_frame, font="Georgia 13", text="Contact name: ", bg="white")
        title_contact_name_label.grid(row=0, column=5)

        for table in tables:
            company_label = Label(canvas_frame, font="Georgia 13", text=table[1], bg="white")
            company_label.grid(row=i, column=0)
            contact_date_label = Label(canvas_frame, font="Georgia 13", text=table[2], bg="white")
            contact_date_label.grid(row=i, column=1)
            action_label = Label(canvas_frame, font="Georgia 13", text=table[3], bg="white")
            action_label.grid(row=i, column=2)
            job_title_label = Label(canvas_frame, font="Georgia 13", text=table[4], bg="white")
            job_title_label.grid(row=i, column=3)
            job_link_label = Label(canvas_frame, font="Georgia 13", text=table[5], bg="white")
            job_link_label.grid(row=i, column=4)
            contact_name_label = Label(canvas_frame, font="Georgia 13", text=table[6], bg="white")
...
def add_new_application():
    ...
    company_name_label = Label(root_add_func, font="Georgia 13", text="Company Name: ", bg="white")
    company_name_label.grid(row=0, column=0)
    company_name_entry = Entry(root_add_func, font="Georgia 13", width=20, background="white")
    company_name_entry.grid(row=0, column=1)
...
ttk.Button(root, text="Add New Application", command=add_new_application).place(anchor="n", x=150, y=100)
ttk.Button(root, text="Change Application", command=change_application).place(anchor="n", x=350, y=100)
ttk.Button(root, text="Show All Applications", command=show_application).place(anchor="n", x=550, y=100)
ttk.Button(root, text="Sort by Date", command=sort_by_date).place(anchor="n", x=350, y=150)
